...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int PERMISSION_SEND_SMS = 341;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = getSupportFragmentManager().findFragmentById(R.id.fragment); // we retrieve the fragment element, what we have in activity_main.xml und <fragment.../>
    ...
    private void notifyDetailFragment(Boolean permissionGranted){
        // we have at that moment no idea in which fragment we are: So we check the active fragment and we need to make sure it is the detail fragment
